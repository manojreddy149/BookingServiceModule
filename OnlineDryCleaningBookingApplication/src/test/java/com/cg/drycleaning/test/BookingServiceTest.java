...
public class BookingServiceTest {
	...
	public void getAllBookingTest() {
		assertEquals(3, iBookingService.getAllBookings().size());
	}
	...
	public void getBookingsByDateTest() {
		Booking booking1 = new Booking(1001L, LocalDate.now(), null, "Drycleaning", null);
		iBookingService.addBooking(booking1);
		assertEquals(1003L, iBookingService.getBookingsByDate(LocalDate.now()).get(0).getBookingId());
	}
	...
	public void getBookingsByCustomerTest() {
		Booking booking1 = new Booking(1001L, LocalDate.now(), null, "Drycleaning", null);
		iBookingService.addBooking(booking1);
		assertEquals("Drycleaning", iBookingService.getBookingsByCustomer("santu").get(0).getServiceType());
	}
}
